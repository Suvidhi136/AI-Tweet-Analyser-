...
cv = CountVectorizer(max_features=1000,tokenizer=my_tokenizer, lowercase=False)
...
clf = tree.DecisionTreeClassifier(max_features=1000, min_samples_leaf=0.01,criterion='entropy',random_state=0)
